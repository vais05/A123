  ...
  <section className="hero" id="home" aria-label="hero" style={{backgroundImage: "url('./assets/images/hero-bg.jpg')"}}>
      <div className="container">
        ...
        <figure className="hero-banner">
          <img src="./assets/images/hero-abs-1 (2).png" width="900" height="900" loading="lazy" aria-hidden="true" className="abs-img abs-img-1" />
          <img src="./assets/images/hero-abs-2 (2).png" width="200" height="200" loading="lazy" aria-hidden="true" className="abs-img abs-img-2" />
        </figure>
      ...
      <div className="container">
        <figure className="about-banner">
          <img src="./assets/images/222.webp" width="450" height="600" loading="lazy" alt="about banner" className="w-100 about-img" />
          <img src="./assets/images/about-abs-1.jpg" width="300" height="242" loading="lazy" aria-hidden="true" className="abs-img abs-img-1" />
        </figure>
      ...
      <section class="container5">
        ...
        <div class="box previous-events" onclick="window.location.href='prevevent.html';" style="cursor:pointer;"/>
          <h2>Past Events</h2>
      ...
      <section class="section cta" aria-label="workshop" style="background-image: url('./assets/images/cta-bg.png')">
        <div class="container">
          ...
          <figure class="cta-banner">
            <img src="./assets/images/2.JPG" width="580" height="380" loading="lazy" alt="cta banner"
              class="img-cover"/>
          </figure>
      ...
      <section class="section event" id="event" aria-label="event">
        <div class="container1">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="event-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/1.JPG" width="250" height="250" loading="lazy"
            ...
            <li>
              <div class="event-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/2.JPG" width="250" height="250" loading="lazy"
            ...
            <li>
              <div class="event-card">
                <figure class="card-banner">
                  <img src="./assets/images/3.JPG" width="250" height="250" loading="lazy"
          ...
          <div class="view-more-container">
            <a href="./Gallery.html" class="btn-view-more">View More</a>
          </div>
        </div>
