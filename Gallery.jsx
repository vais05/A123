        ...
        <li>
            <div class="image-container">
              <figure class="card-banner1">
                <img src="./assets/images/1.jpg" loading="lazy" alt="Innovation & Technological Entrepreneurship Team" class="img-cover"/>
              </figure>
            </div>
          </li>
          <li>
            <div class="image-container">
              <figure class="card-banner1">
                <img src="./assets/images/2.jpg" loading="lazy" alt="Virtual Spring Part-time Jobs Fair for Student" class="img-cover"/>
              </figure>
            </div>
          </li>
          <li>
            <div class="image-container">
              <figure class="card-banner1">
                <img src="./assets/images/3.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
              </figure>
            </div>
          </li>
          <li>
            <div class="image-container">
              <figure class="card-banner1">
                <img src="./assets/images/4.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
              </figure>
            </div>
          </li>
          <li>
            <div class="image-container">
              <figure class="card-banner1">
                <img src="./assets/images/5.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
              </figure>
            </div>
          </li>
          <li>
            <div class="image-container">
              <figure class="card-banner1">
                <img src="./assets/images/6.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
              </figure>
            </div>
          </li>
          <li>
              <div class="image-container">
                <figure class="card-banner1">
                  <img src="./assets/images/7.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                </figure>
              </div>
            </li>
            <li>
              <div class="image-container">
                <figure class="card-banner1">
                  <img src="./assets/images/8.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                </figure>
              </div>
            </li>
            <li>
              <div class="image-container">
                <figure class="card-banner1">
                  <img src="./assets/images/9.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                </figure>
              </div>
            </li>
            <li>
              <div class="image-container">
                <figure class="card-banner1">
                  <img src="./assets/images/10.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                </figure>
              </div>
            </li>
            <li>
              <div class="image-container">
                <figure class="card-banner1">
                  <img src="./assets/images/11.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                </figure>
              </div>
            </li>
            <li>
              <div class="image-container">
                <figure class="card-banner1">
                  <img src="./assets/images/12.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                </figure>
              </div>
            </li> 
            <li>
                <div class="image-container">
                  <figure class="card-banner1">
                    <img src="./assets/images/13.jpg" loading="lazy" alt="Innovation & Technological Entrepreneurship Team" class="img-cover"/>
                  </figure>
                </div>
              </li>
              <li>
                <div class="image-container">
                  <figure class="card-banner1">
                    <img src="./assets/images/14.jpg" loading="lazy" alt="Virtual Spring Part-time Jobs Fair for Student" class="img-cover"/>
                  </figure>
                </div>
              </li>
              <li>
                <div class="image-container">
                  <figure class="card-banner1">
                    <img src="./assets/images/15.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                  </figure>
                </div>
              </li>
              <li>
                <div class="image-container">
                  <figure class="card-banner1">
                    <img src="./assets/images/16.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                  </figure>
                </div>
              </li>
              <li>
                <div class="image-container">
                  <figure class="card-banner1">
                    <img src="./assets/images/17.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                  </figure>
                </div>
              </li>
              <li>
                <div class="image-container">
                  <figure class="card-banner1">
                    <img src="./assets/images/18.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                  </figure>
                </div>
              </li>
              <li>
                  <div class="image-container">
                    <figure class="card-banner1">
                      <img src="./assets/images/19.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                    </figure>
                  </div>
                </li>
                <li>
                  <div class="image-container">
                    <figure class="card-banner1">
                      <img src="./assets/images/20.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                    </figure>
                  </div>
                </li>
                <li>
                  <div class="image-container">
                    <figure class="card-banner1">
                      <img src="./assets/images/21.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                    </figure>
                  </div>
                </li>
                <li>
                  <div class="image-container">
                    <figure class="card-banner1">
                      <img src="./assets/images/22.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                    </figure>
                  </div>
                </li>
                <li>
                  <div class="image-container">
                    <figure class="card-banner1">
                      <img src="./assets/images/23.jpg" loading="lazy" alt="Explorations of Regional Chief Executive Network" class="img-cover"/>
                    </figure>
                  </div>
                </li>
